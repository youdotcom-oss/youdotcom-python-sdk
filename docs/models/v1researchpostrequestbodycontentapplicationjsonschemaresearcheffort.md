...
```python
from youdotcom.models import V1ResearchPostRequestBodyContentApplicationJSONSchemaResearchEffort

value = V1ResearchPostRequestBodyContentApplicationJSONSchemaResearchEffort.LITE
```
