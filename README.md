...
* [`PaymentRequiredResponseError`](./src/youdotcom/errors/paymentrequiredresponseerror.py): Payment Required. Out of credits or quota exceeded. Status code `402`. Applicable to 1 of 7 methods.*
