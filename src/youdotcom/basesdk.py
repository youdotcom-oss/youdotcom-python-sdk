...
def _redact_headers(headers: httpx.Headers) -> httpx.Headers:
    """Return a copy of headers with sensitive values redacted for debug logging."""
    redacted = httpx.Headers(headers)
    ...
    def do_request(
        ...
        if is_error_status_code(http_res.status_code):
            ...
            if result is not None:
                ...
                raise errors.YouDefaultError("Unexpected error occurred", http_res)
        else:
