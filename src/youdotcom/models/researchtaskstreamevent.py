...
class Event(str, Enum):
    r"""The type of the SSE event. Most streams start with a `connected` event and then deliver terminal events `response.done`, `complete`, `error`, or `cancelled` from the worker.
