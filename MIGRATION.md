...
> **This release adds new direct methods and deprecates the old sub-SDK access patterns.** The old patterns still work but emit `DeprecationWarning`. Migrate at your convenience.
