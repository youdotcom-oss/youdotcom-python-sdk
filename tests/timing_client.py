...
This module provides HTTP clients (sync and async) that track timing at multiple layers:
...
class TimingAsyncHTTPClient(httpx.AsyncClient):
    """Async HTTP client that tracks timing for each request."""
    ...
    async def send(
        ...
        *,
        ...
        """Send async HTTP request with timing instrumentation."""
        http_start = time.perf_counter()
    ...
    async def request(
        ...
        *,
        ...
        """Make async HTTP request with timing instrumentation."""
        http_start = time.perf_counter()
